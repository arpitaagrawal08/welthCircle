...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full border-b bg-white/95 dark:bg-zinc-900/80 backdrop-blur z-50 supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-zinc-900/60">
      <nav className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <Image
            src={"/logos/logoWelth.png"}
            alt="Welth Logo"
            width={200}
            height={60}
